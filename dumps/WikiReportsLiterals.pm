...
# mediawiki=>"http://wikimediafoundation.org Wikimedia",
  ...
  eo=>"http://eo.wikipedia.org Esperanto [1,AL]",
  ...
  ia=>"http://ia.wikipedia.org Interlingua [0.0003,AL]",
  ...
  io=>"http://io.wikipedia.org Ido [0.003,AL]",
  ...
  nso=>"http://nso.wikipedia.org Northern Sotho [4.2,AF]",

...
yyyymm=2014-12 # last month to report on  
yyyymm2=2014-11 # previous month for comto compare 
yyyymm_rc=2015-02 # rc is month of RC meeting
...
c1 perl AnalyticsPrepWikiCountsOutputCoreWoOnly.pl -i $csv_dumps -o $csv_rc/$yyyymm -m $yyyymm $unmerged | tee -a $log | cat
exit ;

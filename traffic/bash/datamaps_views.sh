...
echo -e "$job\n" ; # repeated after exec to add to rerouted log
set -x
...
perl TrafficAnalysisGeoDataOutJson.pl # paths still hard coded, to be fixed
cd $wikistats_data/squids/reports
cp datamaps-data.json datamaps-data-$month.json
...
echo "rsync -av datamaps-data.json                                      $htdocs/wikimedia/animations/wivivi"
      rsync -av datamaps-data.json                                      $htdocs/wikimedia/animations/wivivi
echo "rsync -av datamaps-data-$month.*json                              $htdocs/wikimedia/animations/wivivi/$month"
      rsync -av datamaps-data-$month.*json                              $htdocs/wikimedia/animations/wivivi/$month 

cd /home/ezachte/wikistats/worldbank
ls -l
      rsync -av world-bank-demographics.*json                           $htdocs/wikimedia/animations/wivivi/$month 

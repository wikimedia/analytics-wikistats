...
//iOS = true  ; // for tests on desktop
  ...
  var btn_icons_html_on  = "<table><tr><td><font color=blue>Show metrics as <b>icons</b></font>,<br>e.g. show <i>population</i> as </td><td> " + icon_icons + "</td></tr><table>" ;
  var btn_icons_html_off = "<table><tr><td><font color=blue>Show metrics as <b>text</b></font>,<br>e.g. show <i>population</i>, not </td><td> " + icon_icons + "</td></tr><table>" ;
...
//      document.getElementById (select_box_languages).innerHTML = list_select_box_languages2;
  ...
  function showMode () 
  {
    ...
    { 
      ...
      setHtmlById ('icons_explanation', icons_explanation) ;	
  ...
  function adaptToiOS ()
  {
    ...
    btn_icons_html_on  = "Show metrics as icons" ; 
...
console.log ('switchLanguage ' + language) ;
  ...
  //  language_on_display = language ;// qqqqq 
...
//**********************************************************************************************
  ...
  function showTableDialogLanguages (language)
  {
    ...
    language_on_display = data.name ;
    language_name = data.name.replace (/.*:/,'') ;
  //  language_on_display = language ; // qqqq
...
function showMetricsAsIcons (show_icons) 
{
  ...
  { 
    ...
    icons_explanation = '<font color=#AAA>' + 

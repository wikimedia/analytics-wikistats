...
// { Edge = true ; }
  ...
  clear_cookie = false ; // true = force new cookie for dev/debug
...
//iOS = true  ; // for tests on desktop
  ...
  var text_switch_mode_to_regions   = "<table><tr><td><b>&rArr;</b> <img src='WorldSmall2.jpg' border=0 style='margin:0px;padding:0px;border:0px'></td><td>Pageviews to<br>any Wikipedia</td></tr></table>" ; // region" ;
...
//  { throw new Error('This is not an error. This is just to abort javascript'); };
  ...
  if (! (iOS || isAndroid) && (cvw > 900))
  {
    ...
    if (show_splash_screen.indexOf ('skip') < 0)
    { 
...
//console.log (document.getElementById (btn_switch_mode)) ; // .setAttribute("class", "iOSdevice") ;
  ...
  function showStatusInFooter (_status)
  {
    status = _status ;
    if (cvh <= 600) { return ; }
    ...
    { setHtmlById (status_bottom_left, _status.replace (/\<br\>/g,'')) ; }// qqq	
  }

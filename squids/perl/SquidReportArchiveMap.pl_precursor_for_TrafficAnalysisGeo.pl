...
# derived from SquidReportArchive.pl, with new code added for javascript viz. datamaps-views.html
# later renamed into TrafficAnalysisGeo.pl, with lots of old code removed for old traffic reports 
...
# $html .= &ShowCountTd (0)     . "<br>" ;
  ...
  $html .= "<table border=1>\n" ;
  $html .= "<tr><td class=l colspan=99 wrap>The following overview of page requests per client (~browser) application is based on the <a href='//en.wikipedia.org/wiki/User_agent'>user agent</a> information that accompanies most server requests.<br>" .
           ...
           "<b>Recommended reading:</b> <a href='//en.wikipedia.org/wiki/Usage_share_of_web_browsers'>Wikipedia article</a> on usage share of web browsers and measurement methodology." .
           "</td></tr>\n" ;
...
{ 
  ...
  $html .= "<table border=1>\n" ;
  $html .= "<tr><td class=l colspan=99>The following overview of crawler (aka bot) page requests is based on the <a href='//en.wikipedia.org/wiki/User_agent'>user agent</a> information that accompanies most server requests." .
...
sub WriteReportOpSys
{
  ...
  $html .= "<table border=1>\n" ;
  $html .= "<tr><td class=l colspan=99>The following overview of page requests by operating system is based on the <a href='//en.wikipedia.org/wiki/User_agent'>user agent</a> information that accompanies most server requests.<br>" .
           "Please note that agent information does not follow strict guidelines and some programs may provide wrong information on purpose.<br>" .
           "This report ignores all requests where agent information is missing, or contains any of the following: bot, crawl(er) or spider.<p>" .
           "<a href='//en.wikipedia.org/wiki/Windows_NT#Releases'>Wikipedia</a>: NT 5.0: Windows 2000, NT 5.1/5: XP/Srv 2003, NT 6.0: VISTA/Srv 2008, NT 6.1: Windows 7, NT 6.2: Windows 8/Srv 2012, NT6.3: Windows 8.1/Srv 2012 R2.<br> " .
           "<a href='//en.wikipedia.org/wiki/Mac_OS_X#Versions'>Wikipedia</a>: OS X 10.4: Tiger, 10.5: Leopard, 10.6: Snow Leopard, 10.7: Lion, 10.8: Mountain Lion, 10.9: Mavericks.<br> " .
           "<a href='//en.wikipedia.org/wiki/List_of_Linux_distributions'>Wikipedia</a>: Linux distributions." .
           "</td></tr>\n" ;
...
# $html .= "<tr><td colspan=99 class=c><small>All counts x 1000</small></td></tr>\n" ;
  ...
  $html .= "<tr><td width=50% valign=top>" ;
  $html .= "<table border=1 width=100%>\n" ;
# $html .= "<tr><td class=l><b><a href='//..'>External origins</a><br>sorted by<br>frequency</b><br>top 100</td><th class=r>&nbsp;Total</th><th class=r>Pages</th><th class=r>Images</th><th class=r>Other</th></tr>\n" ;
  ...
  foreach $origin (@origin_ext_top_sorted_count)
  {
    ...
    if ($origin =~ /\./)
    { $link_origin = "<a href='//$origin' ref='nofollow'>$origin</a>" ; }
    else
    { $link_origin = $origin ; }
  ...
  $html .= "<table border=1 width=100%>\n" ;
# $html .= "<tr><td class=l><b><a href='//..'>External origins</a><br>sorted by<br>alphabet</b><br>top 100</td><th class=r>&nbsp;Total</th><th class=r>Pages</th><th class=r>Images</th><th class=r>Other</th></tr>\n" ;
...
#          "'Unmatched ip address': all requests without explicit referer url that were not allocated <br>to a site based on known ip range, e.g. google (by ip) or agent string, e.g. google (by agent)</td></tr>" ;
  ...
  $html .= "<table border=1 width=100%>\n" ;
  $html .= "<tr><td class=l><b><a href='//en.wikipedia.org/wiki/Top-level_domain'>Top level domains</a> (tld)<br>sorted by<br>frequency</b></td><th class=r>&nbsp;Total</th><th class=r>Google</th><th class=r>Yahoo</th><th class=r>Other</th></tr>\n" ;
  $html .= "<tr><td colspan=99 class=l>&nbsp;<br><b><a href='//en.wikipedia.org/wiki/Generic_top-level_domain'>Generic</a> and <a href='//en.wikipedia.org/wiki/Sponsored_top-level_domains'>Sponsored</a> tld's</a></b></td></tr>\n" ;
  ...
  $total_yahoo  = 0 ;
  $total_rest   = 0 ;
  $html .= "<tr><td colspan=99 class=l>&nbsp;<br><b><a href='//en.wikipedia.org/wiki/Country_code_top-level_domain'>Country code tld's</a></b></td></tr>\n" ;
  foreach $toplevel (@origin_ext_page_top_sorted_count)
  {
...
# $html .= "<tr><th colspan=99 class=l>&nbsp;<br><b><a href='//en.wikipedia.org/wiki/Top-level_domain'>generic/sponsored tld's</a></b></th></tr>\n" ;
  $total_total  = 0 ;
  $total_google = 0 ;
  $total_yahoo  = 0 ;
  $total_rest   = 0 ;
...
#           "be it the <a href='//en.wikipedia.org/wiki/Googlebot'>GoogleBot</a> crawler or <a href='//www.google.com/feedfetcher.html'>FeedFetcher</a> collector scripts that run on Google servers,<br> " .
#           "or a user that follows a link from a Google Web or Google Desktop search results page, or " .
#           "from Google Maps or Google Earth etcetera. <p>Technically speaking three fields in the <a href='//wikitech.wikimedia.org/view/Squid_log_format'>squid log records</a> are checked for this: " .
...
#           "PERC_GOOGLE\n" ;
  $html .= "<tr><td colspan=99 class=l wrap>&nbsp;<br>This report shows <b>all requests to Wikimedia servers where a Google server of service was involved in any way</b>, " .
           "be it the <a href='//en.wikipedia.org/wiki/Googlebot'>GoogleBot</a> crawler or <a href='//www.google.com/feedfetcher.html'>FeedFetcher</a> collector scripts that run on Google servers, " .
           "or a user that follows a link from a Google Web or Google Desktop search results page, or " .
           "from Google Maps or Google Earth etcetera. <p>Technically speaking three fields in the <a href='//wikitech.wikimedia.org/view/Squid_log_format'>squid log records</a> are checked for this: " .
...
# $total_page_requests_external_fmt = &FormatCount ($total_page_requests_external*1000) ;
  ...
  $html .= "<tr><th colspan=99 class=l><a href='//en.wikipedia.org/wiki/List_of_Internet_top-level_domains'>Top level domains</a></th></tr>\n" ;
...
# $altbgcolor = '#DDFFDD' ;
  ...
  $csv_out = "# category, page views total, page views percentage, mobile, main, search_estimate, all total, percentage, mobile, main, other\n" ;
  $html  = $headerwithperc ;
  $html =~ s/WORLDMAP_D3// ;
...
sub WriteReportCountriesInfo
{
  ...
  $html .= "<tr><td class=hr colspan=3 rowspan=1><b>Location</b></td>" .
               ...
               "<td rowspan=3>&nbsp;</td>" .
               "<td class=hc colspan=10><b>All page views</b></td>" .
               "<td rowspan=3>&nbsp;</td>" .
               "<td class=hc colspan=9><b>To mobile site</b></td></tr>\n" ;
  $html .= "<tr><td class=hr rowspan=2><b>Country</b></td><td class=hc rowspan=2><b>Region</b><br><img src='//stats.wikimedia.org/Location_of_Continents2.gif'></td><td class=hc rowspan=2><b>N/S</b></td>" .
...
sub WriteReportCountryOpSys
{
  ...
  $html .= "<p><table border=1 width=800 class=tablesorter id=table1>\n" ;
  $html .= "<thead>\n" ;
  $html .= "<tr><td class=hr><b>Country</b></td><td class=hc><b>Region</b><br><img src='//stats.wikimedia.org/Location_of_Continents2.gif'></td><td class=hc><b>N/S</b></td>" .
...
window.onload =
  ...
  // button 'form_show_perc' not available on all reports, in fact only obsolete reports
...
# <br>Hover with the mouse and see a breakdown of languages visited from any given country</big></b></font><br>&nbsp;<br>" ;  
}    
#if ($report_id > 20)
#{
